...
export class ExerciseState {
    ...
    @IsIdMap(Viewport)
    public readonly viewports: { readonly [key: UUID]: Viewport } = {};
    @IsMultiTypedIdMap(({ type }) =>
        type === 'simulatedRegion' ? SimulatedRegion : SimulatedRegionStandIn
    )
    public readonly simulatedRegions: {
        readonly [key: UUID]: SimulatedRegion | SimulatedRegionStandIn;
    } = {};
    @IsIdMap(Vehicle)
    public readonly vehicles: { readonly [key: UUID]: Vehicle } = {};
    @IsIdMap(Personnel)
    ...
    static readonly currentStateVersion = ExerciseState__.currentStateVersion;
}
